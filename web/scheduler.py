...
from send_via_preference import format_plain_text_message,render_text_email_html,build_branded_email_html
...
#     # Debug logging
#     current_app.logger.warning("TEXT EMAIL FORMAT = %s", email_format)
#     current_app.logger.warning("HTML BODY START = %r", (html_body or "")[:300])

#     send_branded_email_gmail(user, to_email, subject, html_body)
